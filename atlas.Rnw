...
\author{\textbf{Francois Rousseu} and \textbf{Francois Bolduc\footnote{Environnement et changement climatique Canada, Canadian Wildlife Service, 801-1550, avenue d'Estimauville, Québec, Québec, G1J 0C3. \href{mailto:francois.bolduc@canada.ca}{francois.bolduc@canada.ca}}}\vspace{5cm}}
	...
	load("C:/Users/User/Documents/SCF2016_FR/ECSASatlas/ECSASmaps2.RData") #RData to save at the end of the map script
...
@
	...
	<<pngsp, cache=FALSE, eval=TRUE, include=TRUE, echo=FALSE, message=FALSE, fig.height=4.5,fig.width=6.5, results='asis'>>=
	
	x<-list.files("C:/Users/User/Documents/SCF2016_FR/ECSASatlas/maps")
	x<-x[substr(x,2,2)%in%LETTERS[1:26]]
	g<-grep("season",x)
	if(any(g)){
	  x<-x[-g]
	}
	...
	\clearpage
	\section{Group Maps}	
		<<pnggroup, cache=FALSE, eval=TRUE, include=TRUE, echo=FALSE, message=FALSE, fig.height=4.5,fig.width=6.5, results='asis'>>=
