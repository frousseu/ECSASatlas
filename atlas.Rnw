...
\author{\textbf{Francois Rousseu} and \textbf{Francois Bolduc\footnote{Environnement et changement climatique Canada, Canadian Wildlife Service, 801-1550, avenue d'Estimauville, Québec, Québec, G1J 0C3. \href{mailto:francois.bolduc@canada.ca}{francois.bolduc@canada.ca}}}\vspace{5cm}}
	...
	load("C:/Users/User/Documents/SCF2016_FR/ECSASatlas/final_maps.RData")
...
\clearpage	
<<nbobs, echo=FALSE, include=FALSE, eval=FALSE, message=FALSE, warning=FALSE, results="asis">>=
...
\clearpage
<<effort_maps, cache=FALSE, eval=TRUE, include=FALSE, echo=FALSE, message=FALSE, fig.height=4.5,fig.width=6.5, results='asis'>>=
